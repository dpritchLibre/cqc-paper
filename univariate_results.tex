...
% \begin{proof}
%   This result and proof were given as Lemma 2 in \citep{hennig2016}.
% \end{proof}
...
mentioned in \citep{koenker1978} in the context of quantile regression.  In
...
\begin{proof}
  ...
  special case of Theorem 1 in \citep{hennig2016} for a feature-space of
